...
class TestProductRoutes(TestCase):
    ...
    # Make a GET request to retrieve the product
    ...
    response = self.client.get(f"{BASE_URL}/0")  # Invalid product ID
    ...
    updated_data = {
        ...
        "price": test_product.price + 10,
        "available": not test_product.available,
    ...
    self.assertEqual(Product.find(test_product.id), None)
