...
Scenario: Update a Product
    ...
    And I press the "Retrieve" button
    Then I should see the message "Success"
    And I update the "Description" field to "A blue fedora"
    And I update the "Price" field to "65.95"
    And I click the "Update" button
    Then I should see the message "Success"
    And I should see "A blue fedora" in the "Description" field
    And I should see "65.95" in the "Price" field
...
Scenario: List All Products
    ...
    And I click the "Search" button
    Then I should see the message "Success"
    And I should see multiple products in the product list
...
Scenario: Search for Products by Category
    ...
    And I click the "Search" button
    Then I should see the message "Success"
    And I should see products in the "Cloths" category in the product list
...
Scenario: Search for Products by Availability
    ...
    And I click the "Search" button
    Then I should see the message "Success"
    And I should see only available products in the product list
...
Scenario: Search for Products by Name
    ...
    And I click the "Search" button
    Then I should see the message "Success"
    And I should see "Laptop" in the product list
...
Scenario: Update a Product
    ...
    Then I should see the message "Success"
    And I should see "A red fedora" in the "Description" field
    When I update the "Description" field to "A blue fedora"
